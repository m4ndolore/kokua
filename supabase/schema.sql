...
create table if not exists source_signals (
  ...
  linked_help_hub_id uuid,
  linked_need_summary_id uuid,
...
-- ============================================================
-- DEFERRED FOREIGN KEYS (cross-references between tables)
-- ============================================================

alter table source_signals
  add constraint fk_signals_linked_hub foreign key (linked_help_hub_id) references help_hubs(id);
alter table source_signals
  add constraint fk_signals_linked_summary foreign key (linked_need_summary_id) references public_need_summaries(id);
